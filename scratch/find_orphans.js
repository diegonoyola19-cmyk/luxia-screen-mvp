...
// Entry points always count as "referenced"
...
console.log('\n=== ARBOL DE IMPORTACIONES (' + importedSet.size + ' archivos referenciados) ===');
[...importedSet].sort().forEach(f => console.log('  \u2713  ' + f));

console.log('\n=== POSIBLES HUERFANOS (' + orphans.length + ' archivos) ===');
